...
def run_example(file_tag : str, 
    ...
    try:
        ...
        barrier_certificate, times = find_barrier_certificate(circuit, g, Z, barrier_degree=barrier_degree, eps=epsilon, gamma=gamma, k=k, verbose=verbose, log_level=log_level, precision_bound=precision_bound, solver=solver, check=check)
